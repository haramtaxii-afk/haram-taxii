...
export const metadata: Metadata = {
    ...
    title: 'Taxi Service in Arar | Airport & Intercity Transfers',
    description: 'Reliable taxi in Arar. Transfers to Arar Airport (RAE), Sakaka, and Northern Border cities. 24/7 professional service for business travelers.',
    keywords: ['taxi Arar', 'Arar airport taxi', 'taxi Arar to Sakaka', 'Arar intercity transport', 'Northern Borders taxi'],
    openGraph: {
        title: 'Taxi Service in Arar | Airport Transfers',
        description: 'Professional transport in Arar. Airport pickups and reliable intercity transfers across the Northern region.',
...
export default function ArarLocationPage() {
    const services = [
        {
            name: 'Airport Transfer (RAE)',
            description: 'Prompt pickup and drop-off at Arar Domestic Airport for all flights.',
            icon: Car,
            href: '/services/arar-airport-taxi'
        },
        {
            name: 'Intercity Transfers',
            description: 'Direct and comfortable rides to Sakaka, Turaif, and Rafha.',
            icon: Navigation,
            href: '/services/northern-borders-taxi'
        },
        {
            name: 'Business Chauffeur',
            description: 'Dedicated hourly service for corporate clients and government officials in Arar.',
            icon: Shield,
            href: '/services/hourly-chauffeur'
        },
        {
            name: 'Group Transport',
            description: 'Spacious vehicles for families and groups traveling across the Northern region.',
            icon: ArrowRight,
    ...
    const faqs = [
        {
            question: "How far is Sakaka from Arar?",
            answer: "Sakaka is approximately 180km from Arar, a drive of about 2 hours by private taxi."
        },
        {
            question: "Do you provide airport meet and greet in Arar?",
            answer: "Yes, our driver will wait at the RAE airport exit with a name sign for a hassle-free pickup."
        },
        {
            question: "How much is a taxi to Rafha from Arar?",
            answer: "A trip to Rafha typically costs between 400 SAR and 550 SAR depending on the vehicle type."
        },
        {
        ...
        <div className="bg-amber-50 min-h-screen">
            ...
            <section className="relative h-[600px] flex items-center">
                ...
                <div className="absolute inset-0 bg-stone-800 z-0">
                    <Image
                        ...
                        alt="Taxi Service in Arar Northern Borders"
                        fill
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-600 rounded-full mb-6 animate-fade-in border border-amber-400/50">
                            ...
                            <span className="text-sm font-semibold uppercase tracking-wide">Northern Borders Hub</span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                            Arar Taxi Service
                        </h1>
                        <p className="text-xl md:text-2xl opacity-95 mb-8 leading-relaxed font-light text-amber-50">
                            Professional transfers in Arar City, Northern Borders region, and Arar Airport (RAE).
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Arar." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-amber-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Taxi Prices in Arar</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
                        ...
                        Daily rentals for business travel within Arar are available from <span className="font-bold text-amber-700">600 SAR</span>.
                    </p>
                </div>
            </section>
                            ...
                            <div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-6">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-gray-900">Northern Hub Express</h3>
                                            <p className="text-sm text-gray-600">Fast connections to Sakaka, Turaif, and Rafha industrial zones.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center shrink-0">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                <div className="bg-amber-600 p-6 text-white">
                                    ...
                                    <p className="text-sm opacity-90 mt-1">Airport & City Service</p>
                                </div>
                                <div className="p-6">
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Book Your Ride</h3>
                                        <p className="text-sm text-gray-600 mb-4">Chat with us on WhatsApp for instant booking.</p>
                                        <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Arar." target="_blank" rel="noopener noreferrer" className="block w-full">
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-200">
                                ...
                                <ul className="space-y-3 text-sm text-gray-700">
                                    ...
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-600 rounded-full"></div> Sakaka Road</li>
            ...
            <section className="py-20 bg-gray-900 text-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <p className="text-xl text-gray-400 mb-8">
                        Secure your ride to the airport or any northern city with Arar&apos;s most trusted taxi service.
                    </p>
