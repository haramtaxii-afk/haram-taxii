...
export const metadata: Metadata = {
    ...
    title: 'Taxi Service in Halat Ammar | Tabuk & Regional Shuttles',
    description: 'Premier taxi service in Halat Ammar. Reliable transport for regional travelers and business staff. Direct transfers to Tabuk and Medinah.',
    keywords: ['taxi Halat Ammar', 'Halat Ammar transport', 'Tabuk to Halat Ammar taxi', 'Halat Ammar regional taxi', 'Northern Borders transport'],
    openGraph: {
        title: 'Taxi Service in Halat Ammar | Regional Gateway',
        description: 'Dedicated transport for regional travelers. Reliable transfers to Tabuk and the Holy Cities.',
    ...
    const services = [
        {
            ...
            description: 'Specialized services for travelers and staff moving through the Halat Ammar region.',
            icon: User,
        ...
        },
        {
            ...
            description: 'Taxi services for travelers moving towards the Northern Borders region and Tabuk.',
            icon: Globe,
        ...
        <div className="bg-orange-50 min-h-screen">
            ...
            <section className="relative h-[600px] flex items-center">
                ...
                <div className="absolute inset-0 bg-orange-800 z-0">
                    <Image
                        src="/halat-ammar-hub.webp"
                        alt="Taxi at Halat Ammar Hub"
                        fill
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                            Halat Ammar Regional Taxi
                        </h1>
                        <p className="text-xl md:text-2xl opacity-95 mb-8 leading-relaxed font-light text-orange-50">
                            Reliable regional taxi services to Tabuk and beyond. Professional transport for the North.
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Halat%20Mmar." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                <div className="bg-orange-600 p-6 text-white">
                                    ...
                                    <p className="text-sm opacity-90 mt-1">Regional & City Taxi</p>
                                </div>
                                <div className="p-6">
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Book Your Ride</h3>
                                        <p className="text-sm text-gray-600 mb-4">Chat with us on WhatsApp for instant booking.</p>
                                        <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Halat%20Mmar." target="_blank" rel="noopener noreferrer" className="block w-full">
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-200">
                                ...
                                <ul className="space-y-3 text-sm text-gray-700">
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-orange-600 rounded-full"></div> Regional Logistics Hub</li>
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-orange-600 rounded-full"></div> Tabuk Highway Connection</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-20 bg-gray-900 text-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <p className="text-xl text-gray-400 mb-8">
                        Let us take care of your journey between Halat Ammar and the holy sites.
                    </p>
