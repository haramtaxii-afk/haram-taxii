...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: 'https://www.haramtaxii.com/locations',
        type: 'website',
    },
};
...
export default function LocationsPage() {
    const locations = [
        ...
        },
        {
            name: 'Riyadh',
            slug: 'riyadh',
            description: 'Capital city VIP transfers, Business Chauffeur & Airport Service',
            image: '/riyadh-skyline.webp',
            services: ['VIP Fleet', 'Business Chauffeur', 'Airport Transfer'],
            popular: true,
        },
        {
            name: 'Dammam',
            slug: 'dammam',
            description: 'Eastern Province hub with VIP Bahrain Causeway & Airport transfers',
            image: '/dammam-corniche.webp',
            services: ['VIP Bahrain Taxi', 'Airport Transfer', 'Luxury Chauffeur'],
            popular: true,
        },
        {
            name: 'Al Ula',
        ...
        },
        {
            name: 'Hafr Al Batin',
            slug: 'hafr-al-batin',
            description: 'Kuwait Border crossing (Nuwaiseeb) & KKMC transfers',
            image: '/hafr-al-batin-desert.webp',
            services: ['Kuwait Border Taxi', 'Airport Taxi', 'VIP SUV'],
            popular: false,
        },
        {
            name: 'Arar',
        ...
        },
        {
            name: 'Al Khobar',
            slug: 'khobar',
            description: 'King Fahd Causeway (Bahrain) VIP Taxi & Corniche Service',
            image: '/khobar-water-tower.webp',
            services: ['Bahrain VIP Transfer', 'Airport Taxi', 'Luxury Fleet'],
            popular: true,
        },
        {
            name: 'Al Qurayyat',
        ...
        },
        {
            name: 'Al Khafji',
            slug: 'khafji',
            description: 'Kuwait Border (Al Khafji) & VIP transfers',
            image: '/khafji-corniche.webp',
            services: ['Border Taxi', 'VIP Fleet', 'Dammam Transfer'],
            popular: false,
        },
        {
            name: 'Duba',
        ...
        },
        {
            name: 'Qunfudhah',
            slug: 'al-qunfudhah',
            description: 'Red Sea Coastal Pearl transfers',
