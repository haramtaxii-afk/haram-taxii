...
export const metadata: Metadata = {
    ...
    title: 'Taxi Service in Qurayyat | Airport & City Transfers',
    description: 'Trusted taxi in Al Qurayyat. Reliable transfers to Gurayat Domestic Airport (URY), Turaif, and Sakaka. 24/7 professional transport for business and travel.',
    keywords: ['taxi Qurayyat', 'Gurayat airport taxi', 'taxi Qurayyat to Turaif', 'Qurayyat intercity transport', 'taxi Al Jouf'],
    openGraph: {
        title: 'Taxi Service in Qurayyat | Airport Transfers',
        description: 'Professional transport in Qurayyat. Reliable pickups from Qurayyat Airport (URY) and fast intercity transfers.',
...
export default function QurayyatLocationPage() {
    const services = [
        ...
        },
        {
            ...
            description: 'Comfortable daily rides to Turaif, Sakaka (Al Jouf), and Tabuk.',
            icon: MapPin,
            href: '/services/intercity-taxi'
        },
        {
            name: 'Corporate Chauffeur',
            description: 'Dedicated hourly service for business travelers and official visits in Qurayyat.',
            icon: Shield,
            href: '/services/business-taxi'
        },
        {
            name: 'Group Taxi Service',
            description: 'Large vehicles for families and groups traveling across the Northern region.',
            icon: ArrowRight,
            href: '/services/large-group-taxi'
        }
    ];

    const faqs = [
        {
            question: "How far is Turaif from Qurayyat?",
            answer: "Turaif is approximately 150km from Qurayyat, which takes about 1.5 to 2 hours by private taxi."
        },
        {
            question: "Do you offer airport pickups in Qurayyat?",
            answer: "Yes, we provide 24/7 airport pickup services at Gurayat Domestic Airport (URY). Our driver will be waiting at the arrival hall."
        },
        {
            question: "How much is a taxi to Sakaka from Qurayyat?",
            answer: "A trip to Sakaka typically costs between 350 SAR and 450 SAR depending on the vehicle class."
        },
        {
            question: "Is transport available for early morning flights?",
            answer: "Yes, we operate 24/7. You can book in advance to ensure a car is ready for your early morning flight at URY."
        }
    ];
        ...
        <div className="bg-indigo-50 min-h-screen">
            ...
            <section className="relative h-[600px] flex items-center">
                ...
                <div className="absolute inset-0 bg-stone-800 z-0">
                    <Image
                        src="/qurayyat-city.webp"
                        alt="Taxi Service in Qurayyat City and Airport"
                        fill
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 rounded-full mb-6 animate-fade-in border border-indigo-400/50">
                            ...
                            <span className="text-sm font-semibold uppercase tracking-wide">Northern Business Hub</span>
                        </div>
                        ...
                        <p className="text-xl md:text-2xl opacity-95 mb-8 leading-relaxed font-light text-indigo-50">
                            Professional transfers for Qurayyat City, Gurayat Airport (URY), and northern industrial zones.
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Qurayyat." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-indigo-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Taxi Prices in Qurayyat</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
                        ...
                        Intercity rides to Turaif start from <span className="font-bold text-indigo-700">250 SAR</span>.
                            ...
                            <div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-6">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-gray-900">Regional Experts</h3>
                                            <p className="text-sm text-gray-600">Deep knowledge of Northern Border routes including Turaif and Sakaka highways.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center shrink-0">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                <div className="bg-indigo-600 p-6 text-white">
                                    ...
                                    <p className="text-sm opacity-90 mt-1">Intercity & Airport Rides</p>
                                </div>
                                <div className="p-6">
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Book Your Ride</h3>
                                        <p className="text-sm text-gray-600 mb-4">Chat with us on WhatsApp for instant booking.</p>
                                        <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Qurayyat." target="_blank" rel="noopener noreferrer" className="block w-full">
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-200">
                                ...
                                <ul className="space-y-3 text-sm text-gray-700">
                                    ...
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-indigo-600 rounded-full"></div> Railway Station</li>
            ...
            <section className="py-20 bg-gray-900 text-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    <h2 className="text-4xl font-bold mb-6">Traveling in the North?</h2>
                    <p className="text-xl text-gray-400 mb-8">
                        Let us take you to the airport or any northern city comfortably and on time.
                    </p>
