...
export const metadata: Metadata = {
    ...
    title: 'Taxi Service in Sharurah | Empty Quarter Gateway & Regional Transfers',
    description: 'Specialized taxi service in Sharurah. Reliable transfers to Sharurah Airport (SHW), regional centers, and deep desert transport near the Empty Quarter.',
    keywords: ['taxi Sharurah', 'Sharurah airport taxi', 'Sharurah regional taxi', 'Empty Quarter taxi', 'Sharurah to Najran transport'],
    openGraph: {
        title: 'Taxi Service in Sharurah | Desert Gateway',
        description: 'Your reliable ride in Sharurah. Airport pickups (SHW) and direct transfers to regional hubs and desert sites.',
...
export default function SharurahLocationPage() {
    const services = [
        {
            name: 'Regional Hub Transfers',
            description: 'Direct transfers to the various regional and industrial centers around Sharurah.',
            icon: Flag,
            href: '/services/regional-taxi'
        },
        {
    ...
    const faqs = [
        {
            question: "How long is the drive to Najran?",
            answer: "The drive to Najran is approximately 350km and takes about 3.5 to 4 hours on the desert highway."
        },
        {
            question: "Do you offer airport pickups?",
            answer: "Yes, we provide reliable 24/7 pickup and drop-off services for Sharurah Domestic Airport (SHW)."
        },
        {
        ...
        <div className="bg-yellow-50 min-h-screen">
            ...
            <section className="relative h-[600px] flex items-center">
                ...
                <div className="absolute inset-0 bg-stone-800 z-0">
                    <Image
                        src="/sharurah-hub.webp"
                        alt="Taxi Service in Sharurah Region"
                        fill
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="max-w-3xl text-white">
                        ...
                        <p className="text-xl md:text-2xl opacity-95 mb-8 leading-relaxed font-light text-yellow-50">
                            The most reliable regional taxi service in the South. Direct transfers to Najran and beyond.
                        </p>

                        <div className="flex flex-wrap gap-4">
                            <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Sharurah." target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <section className="py-12 bg-white border-b border-yellow-100">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        ...
                        Regional transfers within the area are typically <span className="font-bold text-yellow-700">60-100 SAR</span>.
                            ...
                            <div>
                                ...
                                <div className="grid sm:grid-cols-2 gap-6">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-gray-900">Regional Specialists</h3>
                                            <p className="text-sm text-gray-600">We specialize in providing reliable transport for the entire Sharurah and Empty Quarter region.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center shrink-0">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden sticky top-24">
                                <div className="bg-yellow-600 p-6 text-white">
                                    ...
                                    <p className="text-sm opacity-90 mt-1">Regional & Airport Rides</p>
                                </div>
                                <div className="p-6">
                                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Book Your Ride</h3>
                                        <p className="text-sm text-gray-600 mb-4">Chat with us on WhatsApp for instant booking.</p>
                                        <a href="https://wa.me/923132222436?text=Hello%20Haram%20Taxi%20Service%2C%20I%20would%20like%20to%20book%20a%20ride%20in%20Sharurah." target="_blank" rel="noopener noreferrer" className="block w-full">
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-200">
                                ...
                                <ul className="space-y-3 text-sm text-gray-700">
                                    ...
                                    <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-yellow-600 rounded-full"></div> Regional Logistics Hub</li>
            ...
            <section className="py-20 bg-gray-900 text-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    <h2 className="text-4xl font-bold mb-6">Traveling in the South?</h2>
                    <p className="text-xl text-gray-400 mb-8">
                        We are the regional transfer specialists in the Sharurah area. Safe and reliable.
                    </p>
